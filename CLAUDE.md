...
- `agents.d/context/TESTING.md` — TDD cycle, TestMints patterns, and test discipline

## Conditional Reads
Load the relevant playbook based on your task type:
- `agents.d/context/PLAYBOOK_CODE_STYLE.md` — when modifying source code (excludes testing, see TESTING.md)
